...
from datagen.util.assessment_stats import Properties, Stats, GradeLevels, DemographicLevels
...
DEMOGRAPHICS_BY_GRADE = {
    # these were just copied from grade 1
    0: Properties(
...
LEVELS_BY_GRADE_BY_SUBJ = {
    "Math": {
        ...
        0: GradeLevels((32.0, 24.0, 24.0, 20.0),  # (14.0, 30.0, 49.0, 7.0),
    ...
    "ELA": {
        # these (KG) values were just copied from grade 1
        0: GradeLevels((32.0, 24.0, 24.0, 20.0),  # (9.0, 30.0, 48.0, 13.0),
                       dmg_prg_504=DemographicLevels(
