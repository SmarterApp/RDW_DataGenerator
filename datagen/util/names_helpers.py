...
def _read_name_files(males_first, females_first, all_last):
    ...
    try:
        ...
        male_first_name_frequency_dict, female_first_name_frequency_dict, last_name_frequency_dict = \
            _generate_all_names(male_names, female_names, last_names)
...
def _generate_all_names(male_list, female_list, last_name_list, pool_size=1000000):
    ...
    :param last_name_list: List of last name NameInfo objects
