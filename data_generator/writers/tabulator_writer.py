...
TabulatorFieldNames = [
    ...
    'ItemType', 'Grade', 'Standard', 'Claim', 'Target', 'OtherClaimTargets', 'CommonCore', 'PassageRef', 'ASL',
    'Braille', 'LanguageBraille', 'DOK', 'Language', 'AllowCalculator', 'MathematicalPractice', 'MaxPoints',
    'Glossary', 'ScoringEngine', 'Spanish', 'IsFieldTest', 'IsActive', 'ResponseRequired', 'AdminRequired',
    'FormPosition', 'MeasurementModel', 'Weight', 'ScorePoints', 'a', 'b0_b', 'b1_c', 'b2', 'b3', 'avg_b', 'bpref1',
    'bpref2', 'bpref3', 'bpref4', 'bpref5', 'bpref6', 'bpref7', 'CutPoint1', 'ScaledLow1', 'ScaledHigh1', 'CutPoint2',
    'ScaledLow2', 'ScaledHigh2', 'CutPoint3', 'ScaledLow3', 'ScaledHigh3', 'CutPoint4', 'ScaledLow4', 'ScaledHigh4'
]
