...
def generate_district(district_type, state: State, district_types=hier_config.DISTRICT_TYPES):
...
def generate_school(school_type, district: District, school_types=hier_config.SCHOOL_TYPES):
