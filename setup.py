...
setuptools.setup(name='DataGeneration',
                 ...
                 packages=['data_generator',
                           ...
                           'data_generator.datafiles',
                           'data_generator.generators',
                           'data_generator.model',
                           'data_generator.outputworkers',
                           'data_generator.readers',
                           'data_generator.sbac_generators',
                           'data_generator.util',
                           'data_generator.writers'],
                 package_data={'data_generator.datafiles': ['*.txt', '*.last', '*.first']},
